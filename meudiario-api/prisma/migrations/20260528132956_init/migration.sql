...
-- CreateIndex
CREATE UNIQUE INDEX "Mood_noteId_key" ON "Mood"("noteId");
...
-- AddForeignKey
ALTER TABLE "Mood" ADD CONSTRAINT "Mood_noteId_fkey" FOREIGN KEY ("noteId") REFERENCES "Note"("id") ON DELETE SET NULL ON UPDATE CASCADE;
